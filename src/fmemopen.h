...
/* undefine some macro definitions which have been defined already by
   the scheme configuration header */
#undef PACKAGE
...
/*!
    \file fmemopen.h
    \brief BSD port of the fmemopen Linux method using funopen
 ...
 *
 * \param buf The data that will be used to back the FILE* methods. Must be at least @c size bytes.
...
#endif /* #ifndef HAVE_FMEMOPEN */

#endif /* #ifndef FMEMOPEN_H */
